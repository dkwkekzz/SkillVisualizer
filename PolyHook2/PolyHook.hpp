...
#define Detour X64Detour
	...
	public:
		...
		virtual bool Hook() override;
		virtual HookType GetType() override;
		void SetupHook(uint8_t* Src, uint8_t* Dest, uint8_t* Mid = nullptr);
...
void 
PLH::X64Detour::SetupHook(uint8_t* Src, uint8_t* Dest, uint8_t* Mid)
{
	PLH::AbstractDetour::SetupHook(Src, Dest);
	m_hkMid = Mid;
}
...
bool PLH::X64Detour::Hook()
{
	...
	constexpr int hookingLen = callLen;
